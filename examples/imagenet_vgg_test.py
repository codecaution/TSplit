...
if __name__ == "__main__":
    ...
    execution_time = vgg(16, 16, policy = "tsplit")
    print(execution_time)
    # file_name = "./exp/resnet50_imagenet_batchsize_time_vdnn_all_no_workspace.txt"
    # file_name = "./experiment/base_vgg16_batchsize_time.txt"
    # output_file = open(file_name, 'w', buffering=1)
    # for batch_size in range(1, 100):
    #     execution_time = vgg(batch_size, 16, policy = None)
