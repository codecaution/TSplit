...
def test_batch_size():
    ...
    # output_file = open("./conv_exp/convForward_batch_size.txt", 'w', buffering=1)
    # output_file.write("Input size = batch_size, 64, 32, 32\n")
    # output_file.write("kernel size = 128, 64, 3, 3\n")
    # output_file.write("Output size = batch_size, 128, 32, 32\n")

    # output_file1 = open("./conv_exp/backward_filter_batch_size.txt", 'w', buffering=1)
    # output_file1.write("Conv backward of filter\n")
    # output_file1.write("Input size = batch_size, 64, 32, 32\n")
    # output_file1.write("kernel size = 128, 64, 3, 3\n")
    # output_file1.write("Output size = batch_size, 128, 32, 32\n")

    # output_file2 = open("./conv_exp/backward_data_batch_size.txt", 'w', buffering=1)
    # output_file2.write("Conv backward of data\n")
    # output_file2.write("Input size = batch_size, 64, 32, 32\n")
    # output_file2.write("kernel size = 128, 64, 3, 3\n")
    # output_file2.write("Output size = batch_size, 128, 32, 32\n")

    output_file = open("./conv_exp/convForward_batch_size_2.txt", 'w', buffering=1)
    output_file.write("Input size = batch_size, 64, 224, 224\n")
    output_file.write("kernel size = 128, 64, 3, 3\n")
    output_file.write("Output size = batch_size, 128, 224, 224\n")

    # output_file1 = open("./conv_exp/backward_filter_batch_size2.txt", 'w', buffering=1)
    # output_file1.write("Conv backward of filter\n")
    # output_file1.write("Input size = batch_size, 64, 224, 224\n")
    # output_file1.write("kernel size = 128, 64, 3, 3\n")
    # output_file1.write("Output size = batch_size, 128, 224, 224\n")

    # output_file2 = open("./conv_exp/backward_data_batch_size_2.txt", 'w', buffering=1)
    # output_file2.write("Conv backward of data\n")
    # output_file2.write("Input size = batch_size, 64, 224, 224\n")
    # output_file2.write("kernel size = 128, 64, 3, 3\n")
    # output_file2.write("Output size = batch_size, 128, 224, 224\n")

    for batch_size in range(1, 300):
        ...
        # for t in range(5):
        #     conv_grad_filter_op.op.profile(conv_grad_filter_op, [X_val, output_val], W0_val, is_static = False)
        #     time += conv_grad_filter_op.profiler.time
        # output_file1.write("Batch size = %d , execute time = %.5f ms\n"%(batch_size, time/5.0))
        ...
        # for t in range(5):
        #     conv_grad_data_op.op.profile(conv_grad_data_op, [W0_val, output_val], X_val, is_static = False)
        #     time += conv_grad_data_op.profiler.time
        # output_file2.write("Batch size = %d , execute time = %.5f ms\n"%(batch_size, time/5.0))
